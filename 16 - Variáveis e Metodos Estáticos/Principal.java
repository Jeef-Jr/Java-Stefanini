...
import com.stefanini.aprendendo.entidades.Carro;
import com.stefanini.aprendendo.entidades.Tesla;
...
//		bmw.taxaAceleracao = 50;
		...
		Carro ferrari = new Carro("Ferrari", "488");
		
		
		if(ferrari.getModelo() == Constantes.MODELO_FAMOSO) {
			System.out.println("Esse modelo é famoso!");
		}
